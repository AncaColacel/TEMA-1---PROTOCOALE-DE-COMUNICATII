...
// trimite frame-ul de dimensiunea len la interfata interface
...
// primeste length numar de date pe care le copiaza in frame_data
// functie blocanta (opreste executia programului pana sunt pachete disponibile sa primeasca)
...
// citeste tabela de rutare de la adresa path si o pune in structura *rtable
